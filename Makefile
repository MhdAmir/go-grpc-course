...
.DEFAULT_GOAL := help
.PHONY: greet blog calculator summary help
project := greet calculator blog summary
...
summary: $@ ## Generate Pbs and build for summary
...
clean: clean_greet clean_calculator clean_blog clean_summary## Clean generated files
	${RM_F_CMD} ssl/*.crt
	${RM_F_CMD} ssl/*.csr
	${RM_F_CMD} ssl/*.key
	${RM_F_CMD} ssl/*.pem
...
clean_summary: ## Clean generated files for summary
	${RM_F_CMD} summary/${PROTO_DIR}/*.pb.go
